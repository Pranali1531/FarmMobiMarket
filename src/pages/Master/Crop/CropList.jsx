...
export default function CropList({ onAdd, onEdit }) {
...
const user = useSelector((state) => state.auth.user);
  ...
  // TABLE ROWS
  // -------------------------
  const rows = paginatedCrops.map((crop) => ({
    cropName: (
      <MDBox display="flex" alignItems="center" gap={2}>
        <Avatar src={crop.avatar} alt={crop.cropName} />
        ...
        >
          ...
          <MDBox display="flex" alignItems="center" gap={2}>
            ...
            <MDTypography variant="button" color="text">
              ...
              {Math.min(endIndex, filteredCrops.length)} of{" "}
          ...
          <MDBox display="flex" alignItems="center" gap={1} mb={2}>
            {[
              ...Array(Math.ceil(filteredCrops.length / entriesPerPage)).keys(),
            ].map((i) => (
              <button
                key={i}
